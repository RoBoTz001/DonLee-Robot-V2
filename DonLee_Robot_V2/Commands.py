...
async def about(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[
          Import.Button("💠join Our Group💠", url='https://t.me/Moviez_group_mg'),
...
async def sub(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[     
          Import.Button("👨‍💼 Owner", url="https://t.me/cinemaclubcc"),
          Import.Button("𝖲𝗎𝗉𝗉𝗈𝗋𝗍 Group🤝", url="https://t.me/Moviez_group_mg")
          ],[
          Import.Button("📢𝖴𝗉𝖽𝖺𝗍𝖾𝗌 Channel", url="https://t.me/MM_CINEMA_CLUB"),
          Import.Button("Bot Updates💞", url="https://t.me/PRO_BOT_CHANNEL_PBC")
          ],[
          Import.Button("📦𝖦𝗂𝗍𝗁𝗎𝖻", url="https://github.com/RoBoTz001"),
          Import.Button("channel 😁", url="https://t.me/Cinema_Club_Post")
          ],[
          Import.Button("𝖢𝗅𝗈𝗌𝖾🗑️", callback_data="close")
          ]]                     
        await bot.send_photo(
...
async def admin(bot, msg):
    button = [[  
       Import.Button("𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾➡️", url="https://t.me/cinemaclubcc")
       ]]
    await msg.reply_text(
